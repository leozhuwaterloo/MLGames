...
var _BlockAnimation = __webpack_require__(29);

var _BlockAnimation2 = _interopRequireDefault(_BlockAnimation);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_BlockAnimation2.default, null)
      );
    }
  }]);
...
var _reactP5Wrapper = __webpack_require__(30);

var _reactP5Wrapper2 = _interopRequireDefault(_reactP5Wrapper);

var _MusicPlayer = __webpack_require__(38);
...
var BlockAnimation = function (_React$Component) {
  _inherits(BlockAnimation, _React$Component);

  function BlockAnimation(props) {
    _classCallCheck(this, BlockAnimation);

    return _possibleConstructorReturn(this, (BlockAnimation.__proto__ || Object.getPrototypeOf(BlockAnimation)).call(this, props));
  }
  ...
  _createClass(BlockAnimation, [{
    ...
    value: function sketch(p) {
      ...
      p.setup = function () {
        ...
        p.setWindow();
        p.loadSound("/static/ml/media/HYLO.mp3");
      };
      ...
      p.draw = function () {
        ...
        p.normalMaterial();
        for (var z = -length / 2; z < length / 2; z += w) {
          for (var x = -length / 2; x < length / 2; x += w) {
            p.push();
            var d = p.dist(x, z, 0, 0);
            var offset = p.map(d, 0, maxD, -p.PI, p.PI);
            var a = angle + offset;
            var h = p.floor(p.map(p.sin(2 * a), -1, 1, 150, length * 0.6));
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_reactP5Wrapper2.default, { sketch: this.sketch }),
        _react2.default.createElement(_MusicPlayer2.default, { audio: '/static/ml/media/HYLO.mp3' })
      );
    }
  }]);
...
exports.default = BlockAnimation;
...
var _p5 = __webpack_require__(31);
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open '/root/myproject/node_modules/p5/lib/p5.js'");
...
var MusicPlayer = function (_React$Component) {
  ...
  function MusicPlayer(props) {
    ...
    if (props.audio) _this.audio = { __html: '<source src="' + props.audio + '" type="audio/mpeg">' };else _this.audio = { __html: '<source src="" type="audio/mpeg">' };

    if (props.style) _this.style = props.style;else {
      _this.style = {
        position: "absolute",
        right: "0px",
        top: "0px"
  ...
  _createClass(MusicPlayer, [{
    key: 'test',
    value: function test(p) {
      console.log(p);
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2.default.createElement('audio', { controls: true, preload: 'true', autoPlay: true, style: this.style, onPlaying: this.test, dangerouslySetInnerHTML: this.audio });
    }
  }]);
